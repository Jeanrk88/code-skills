...
description: Audita código em nível world-class em todas as camadas. Use esta skill quando o usuário pedir revisão, auditoria, validação técnica, code review profundo, análise de arquitetura, segurança, performance, resiliência, custo, infraestrutura, dados ou escala. Não avalia estilo ou lint; avalia estrutura, segurança, resiliência, performance e custo.
...
Pra cada finding:[CRÍTICO/ALTO/MÉDIO/BAIXO] Título
